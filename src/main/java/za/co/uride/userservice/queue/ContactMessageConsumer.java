...
public class ContactMessageConsumer {
    ...
    @Bean
    public SimpleMessageListenerContainer contactMessageListenerContainer() {
    ...
    @Bean
    public MessageListener contactMessageListener() {
        return message -> {
            ...
            NotificationContactReqDto notificationContactReqDto = gsonMapper.fromJson(new String(message.getBody()), NotificationContactReqDto.class);
